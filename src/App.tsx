...
const footerNavigation = {
  social: [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/estebancreate/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Example() {
  return (
    <div className="bg-esteban_blue">
            ...
            <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                  <a
                    href="#"
                    className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-esteban_blue shadow-sm hover:bg-indigo-50 sm:px-8"
                  >
                    See my resume
                  </a>
                </div>
      ...
      <footer className="bg-esteban_blue" aria-labelledby="footer-heading">
