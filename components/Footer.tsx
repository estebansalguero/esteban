...
const footerNavigation = {
  social: [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/esteban-salguero-24b707232/",
      icon: (props: any) => (
...
export const Footer = () => {
  return (
    <footer
      className="bg-esteban_blue mt-auto"
      aria-labelledby="footer-heading"
    >
      <h2 id="footer-heading" className="sr-only">
        Footer
      </h2>
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-12">
